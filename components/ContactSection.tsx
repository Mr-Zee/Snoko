      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our ice candies or want to become an investor?
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Westlake Food Products Kalikavu Road, Wandoor Malappuram
                      Dt., 679328, Kerala
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      SNOKO ICE CANDY Aryad Road, South Moolamkuzhi, Mundamveli
                      po , kochi - 682507
                    </p>
                  </div>
                </div>
